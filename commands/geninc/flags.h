...
// ps P(ppid)*aAdeflo*p(pid)*s*t*u*U*g*G*wZ[!ol][+Ae] P(ppid)*aAdeflo*p(pid)*s*t*u*U*g*G*wZ[!ol][+Ae]
#undef OPTSTR_ps
#define OPTSTR_ps "P(ppid)*aAdeflo*p(pid)*s*t*u*U*g*G*wZ[!ol][+Ae]"
#ifdef CLEANUP_ps
#undef CLEANUP_ps
#undef FOR_ps
#undef FLAG_Z
...
// unshare <1^rimnpuU <1^rimnpuU
#undef OPTSTR_unshare
#define OPTSTR_unshare "<1^rimnpuU"
