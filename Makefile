...
CSRCS = shell/alias.c shell/arith_yacc.c shell/arith_yylex.c \
	...
	commands/other/readlink.c commands/other/realpath.c \
	commands/other/rev.c \
	commands/other/setsid.c commands/other/shred.c \
	commands/other/sysctl.c commands/other/tac.c \
	commands/other/timeout.c commands/other/truncate.c \
	commands/other/usleep.c commands/other/vmstat.c \
...
#	commands/other/hostid.c \
#	commands/other/flock.c commands/other/ifconfig.c \
...
#	commands/other/readahead.c \
#	commands/other/reboot.c commands/other/reset.c \
...
#	commands/other/taskset.c commands/other/uptime.c \
#	commands/other/vconfig.c commands/other/w.c \
...
CFLAGS += -I. -Ishell -Ilibedit -Icommands -Itoylib -DSHELL -DHAVE_CONFIG_H -include config.h
